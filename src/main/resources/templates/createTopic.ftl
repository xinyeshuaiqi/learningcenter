...
<div class="card" style="width: 50%;margin: 200px auto">
    ...
    <div class="card-body" style="font-family: YouYuan">
        ...
        <h2 class="card-title" style="font-family: YouYuan">发表帖子</h2>
        <br/>
        <br/>

        <form class="layui-form " action="/toCreateTopic">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="content" placeholder="内容" class="layui-textarea" lay-verify="required" maxlength="300"></textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    ...
                    <button class="layui-btn layui-btn" lay-submit lay-filter="formDemo">立即提交</button>
                </div>
            </div>
        </form>
