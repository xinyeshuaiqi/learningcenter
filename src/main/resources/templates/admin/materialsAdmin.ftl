            ...
            <div class="container-fluid">
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="brand-text d-none d-lg-inline-block"><strong>华大学城后台管理</strong></div>
    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <ul class="list-unstyled">
                ...
                <li class="active"><a href="/materialsAdmin"> <i class="icon-grid"></i>资料管理 </a></li>
        ...
        <div class="content-inner">
            ...
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">资料管理</h2>
                </div>
            </header>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            layer.msg('删除成功！', {time:1000}
                                    ,function () {
                                        window.location.href = "/materialsAdmin";
                                    }
                            );
                        } else {
                            layer.msg('删除失败！');
