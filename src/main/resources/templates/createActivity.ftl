    ...
    <div class="container" >
        <div  class="col-md-6 agileinfo_about_grids_bottom_right">
            <div class="agileinfo_about_grids_bottom_right-pos" style="margin-left: 600px;background-color: cornsilk">
                <h3 style="font-family: YouYuan;">创建学习活动 &nbsp;  <span style="color: red;font-size: x-large">${createActivity!""}</span></h3>


                <br/>

                <form action="/toCreateActivity" id="activity_form" style="font-family: YouYuan" onsubmit="return checkValue()">

                    <table>
                        <tr>
                            <td>主题:&nbsp;</td>
                            <td width="400px"><input type="text" class="form-control" id="topic" name="topic"></td>
                        ...
                        <tr>
                            <td>描述:&nbsp;</td>
                            <td width="400px">
                                <textarea class="form-control"  rows="4" id="description" name="description" maxlength="50" style="resize: none"></textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>时间:&nbsp;</td>
                            <td width="400px">
                               <input type="datetime-local" placeholder="活动开始时间" class="form-control" id="startTimeStr" name="startTimeStr"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>地点:&nbsp;</td>
                            <td width="400px"><input type="text" class="form-control" id="address" name="address">
                            </td>
                    ...
                    &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                    &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                    <button type="submit" class="btn btn-outline-danger">创建</button>
