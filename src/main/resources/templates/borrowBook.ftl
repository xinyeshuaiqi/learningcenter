...
<div class="card" style="width: 50%;margin: 200px auto">
    ...
    <div class="card-body" style="font-family: YouYuan">
        ...
        <br/>
        <br/>
        <h2 class="card-title" style="font-family: YouYuan">借出书籍</h2>
        <br/>
        <br/>

        <form class="layui-form " action="/toBorrowBook">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="name" name="name" required  lay-verify="required" placeholder="请输入书名" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="description" placeholder="简单描述书的内容" class="layui-textarea" lay-verify="required" maxlength="30"></textarea>
            </div>
        </div>
