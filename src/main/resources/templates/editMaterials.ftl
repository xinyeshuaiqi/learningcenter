...
<div class="card" style="width: 50%;margin: 200px auto">
    ...
    <div class="card-body" style="font-family: YouYuan">
        <h2 class="card-title" style="font-family: YouYuan">编辑资料信息</h2>
        <br/>
        <br/>

        <form class="layui-form " action="/toEditMaterials">

            <input type="hidden" id="filePath" name="filePath" value="${(materials.filePath)!""}"/>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="name" name="name" required  lay-verify="required" placeholder="请输入资料名" autocomplete="off" class="layui-input" value="${(materials.name)!""}">
                </div>
            </div>
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="description" placeholder="简单描述资料的内容" class="layui-textarea" lay-verify="required" maxlength="30">${(materials.description)!""}</textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    ...
                    <button class="layui-btn layui-btn-radius layui-btn-normal" lay-submit lay-filter="formDemo">编辑</button>
                </div>
            </div>
        </form>
